...
{
	//TODO: Cleanup
	public class LookJoystick : MonoBehaviour, ISimpleInputDraggable
	{
...
// #endif
		...
		{		
			//?_currentTouch = FindTouchByFingerId(eventData.pointerId);  //!!!
...
//!-------------------------------------------------------------------------------
		...
		// private Touch FindTouchByFingerId(int fingerId)
		// {
		...
		// 		}
		// 	}
		// 	return new Touch(); // Возвращаем пустое касание, если не найдено касание с заданным идентификатором
		// }
	}
}